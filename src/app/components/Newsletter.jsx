...
export default function Newsletter() {
    return(
        <div className="flex flex-col bg-green-200/25 font-bold p-5 px-60">
            ...
            <form>
                <div className="flex gap-5">
                    <input className="form-input block basis-3/4 text-white bg-white/50 focus:bg-white px-5 rounded-sm" type="text" required autoComplete="off" autoCorrect="off" spellCheck="false" placeholder="Name" id="name" defaultValue="" />
