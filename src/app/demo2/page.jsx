        ...
        <div class="bg-gradient-to-b from-green-950 to-stone-800">
            <div class="flex flex-col gap-10 py-10 bg-fixed bg-center bg-no-repeat bg-[url('https://www.pngrepo.com/png/923/180/leaf.png')] bg-blend-multiply h-max">
                <div class="grid grid-cols-9">
                    ...
                    <div class="col-span-7 flex flex-col gap-10 p-5 justify-center bg-green-700 items-center text-white">
                        <h1 class="text-7xl">
                            Aya!
                        </h1>
                        <h2>
                ...
                <div class="grid grid-cols-9">
                    <div class="col-span-1" />
                    <div class="col-span-3 flex flex-col bg-white/50 p-5 gap-5">
                ...
                <div class="grid grid-cols-9">
                    <div class="col-span-1" />
                    <div class="col-span-7 flex justify-center bg-green-700">
